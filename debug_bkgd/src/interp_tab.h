...
// DAVID:
#define INTERP_TAB_FR_MULT 20.0
...
// DAVID: change the min exponent so there is greater resolution for small distances
#define INTERP_TAB_MIN_EXP -54
//#define INTERP_TAB_MIN_EXP -45
// #define INTERP_TAB_MIN_EXP -20  (original value)
...
// DEBUG: add print out variable arg to each function
// InterpTab *interp_tab_create(double (*f)(double,double,void *), void *, FILE *fh);
// InterpTab *interp_tab_create_1d(double (*f)(double,void *), void *, FILE *fh);
